...
ATOM_FEATURE_DIM = DGIN5_ATOM_FEATURE_DIM
EDGE_FEATURE_DIM = DGIN5_EDGE_FEATURE_DIM
...
class BasicModelConfig:
    ...
    """
    model_name: str = 'all_logs_dgin5_1' # without h_w in DGIN gin part - added h_v_0 instead
    ...
    train_data_dir: str = project_path+'data/processed/lipo/pickled/train_dgin5_logd/'
    test_data_dir: str = project_path+'data/processed/lipo/pickled/test_dgin5_logd/'
    ...
    model_type: str = 'DGIN' # added 31.03.2021 to compare models like 'GIN' 'DMPNN' 'DGIN' 'MLP'
...
class DGINConfig:
    ...
    input_size_gin: int = (ATOM_FEATURE_DIM+passing_hidden_size) # changed 31.03.2021;  (ATOM_FEATURE_DIM) is for GIN only; 
