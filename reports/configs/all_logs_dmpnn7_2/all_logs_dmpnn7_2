...
ATOM_FEATURE_DIM = DGIN7_ATOM_FEATURE_DIM
EDGE_FEATURE_DIM = DGIN7_EDGE_FEATURE_DIM
...
class BasicModelConfig:
    ...
    """
    model_name: str = 'all_logs_dmpnn7_2' # without h_w in DGIN gin part - added h_v_0 instead
    ...
    train_data_dir: str = project_path+'data/processed/lipo/pickled/train_dgin7_logd/'
    test_data_dir: str = project_path+'data/processed/lipo/pickled/test_dgin7_logd/'

    combined_dataset: bool = True

    add_train_data_dir: str = project_path+'data/processed/lipo/pickled/train_dgin7_logs/'
    add_test_data_dir: str = project_path+'data/processed/lipo/pickled/test_dgin7_logs/'
...
class DGINConfig:
    ...
    input_size_gin: int = (ATOM_FEATURE_DIM) # changed 31.03.2021;  (ATOM_FEATURE_DIM) is for GIN only; 
                                              #  otherwise: (ATOM_FEATURE_DIM+passing_hidden_size)
...
class Model1Config:
    ...
    # endpoint. 
    best_evaluation_threshold: float = 2.75 #was introduced on the 25.03.2021/ 
