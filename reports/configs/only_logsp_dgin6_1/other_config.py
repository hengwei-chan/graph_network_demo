...
class BasicModelConfig:
    ...
    """
    model_name: str = 'only_logsp_dgin6_1' # without h_w in DGIN gin part - added h_v_0 instead
    ...
    train_data_dir: str = project_path+'data/processed/lipo/pickled/train_dgin6_logs/'
    test_data_dir: str = project_path+'data/processed/lipo/pickled/test_dgin6_logs/'
