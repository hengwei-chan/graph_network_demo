...
class BasicModelConfig:
    ...
    """
    model_name: str = 'only_logsp_dgin5_1' # without h_w in DGIN gin part - added h_v_0 instead
...
class Model1Config:
    ...
    # endpoint. 
    best_evaluation_threshold: float = 1.75 #was introduced on the 25.03.2021/ 
