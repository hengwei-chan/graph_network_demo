...
from graph_networks.utilities import change_input,write_out, plot,get_r2
...
class BaseModel(tf.keras.Model):
    ...
    def __init__(self,config):
        ...
        self.lipo_loss_mae = self.config.lipo_loss_mae

        self.best_value_test = self.config.best_evaluation_threshold
        self.best_value_validation = self.config.best_evaluation_threshold
    ...
    def test(self, test_data,epoch,test_losses=None,save_weights_flag=True,include_dropout=False,predict_n_times=1,
            simply_testing=True,consensus=False):
        '''
    ...
    def test_n_times(self, test_data,epoch,test_losses=None,save_weights_flag=True,include_dropout=False,predict_n_times=1,
            simply_testing=True,also_evaluate=False,eval_data=None,consensus=False):
        '''
        tests the trained model by using the test data by calling the call method.
